...
public class Dashboard {
    ...
    public static void updateLineSensorsC(LineFollowerC lineFollower) {
        ...
        // SmartDashboard.putNumber(addressString + "Cargo Distance",
        // lineFollower.infraredC.getVoltage());
    }
    ...
    public static void updateCANSparkMax(CANSparkMax sparkMax, String label) {
        ...
        // SmartDashboard.putNumber(addressString + "Bus_Voltage",
        // sparkMax.getBusVoltage());
        SmartDashboard.putNumber(addressString + "Output_Percent", sparkMax.get());
        // SmartDashboard.putNumber(addressString + "Output_Voltage",
        ...
        // SmartDashboard.putString(addressString + "Control_Mode",
        // sparkMax.getPIDController().toString());
        // SmartDashboard.putNumber(addressString + "Temperature",
        // sparkMax.getMotorTemperature());
        // SmartDashboard.putBoolean(addressString + "isInverted",
    ...
    public static void updateArmBoolean() {
    ...
    public static void updateTalon(TalonAbsolute talon, String label) {
        ...
        // SmartDashboard.putNumber(addressString + "Output Voltage",
        // talon.getMotorOutputVoltage());
        SmartDashboard.putNumber(addressString + "Output Current", talon.getOutputCurrent());
        // SmartDashboard.putNumber(addressString + "Output Watts",
        // talon.getOutputCurrent() * talon.getMotorOutputVoltage());
    ...
    public static void updateNavX() {
        ...
        // SmartDashboard.putBoolean(addressString + "Connected",
        // NavX.getNavx().isConnected());
        // SmartDashboard.putNumber(addressString + "Gyro/Pitch",
        // NavX.getNavx().getPitch());
        // SmartDashboard.putNumber(addressString + "Gyro/Roll",
        // NavX.getNavx().getRoll());
        // SmartDashboard.putNumber(addressString + "Gyro/Yaw",
        // NavX.getNavx().getYaw());
        // SmartDashboard.putNumber(addressString + "Altitude",
        // NavX.getNavx().getAltitude());
        // SmartDashboard.putNumber(addressString + "Displacement/X",
        // NavX.getNavx().getDisplacementX());
        // SmartDashboard.putNumber(addressString + "Displacement/Y",
        // NavX.getNavx().getDisplacementY());
        // SmartDashboard.putNumber(addressString + "Displacement/Z",
        // NavX.getNavx().getDisplacementZ());
        // SmartDashboard.putNumber(addressString + "CompassHeading",
        // NavX.getNavx().getCompassHeading());
        // SmartDashboard.putNumber(addressString + "Velocity/X",
        // NavX.getNavx().getVelocityX());
        // SmartDashboard.putNumber(addressString + "Velocity/Y",
        // NavX.getNavx().getVelocityY());
        // SmartDashboard.putNumber(addressString + "Velocity/Z",
        // NavX.getNavx().getVelocityZ());
        // SmartDashboard.putNumber(addressString + "BarometricPressure",
        // NavX.getNavx().getBarometricPressure());
        // SmartDashboard.putNumber(addressString + "Quaternion/W",
        // NavX.getNavx().getQuaternionW());
        // SmartDashboard.putNumber(addressString + "Quaternion/X",
        // NavX.getNavx().getQuaternionX());
        // SmartDashboard.putNumber(addressString + "Quaternion/Y",
        // NavX.getNavx().getQuaternionY());
        // SmartDashboard.putNumber(addressString + "Quaternion/Z",
        // NavX.getNavx().getQuaternionZ());
        // } else {
